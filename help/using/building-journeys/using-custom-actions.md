...
Om du använder en anpassad åtgärd visas i skrivskyddat läge de parametrar **[!UICONTROL URL Configuration]**och**[!UICONTROL Authentication]** parametrar som definierats i åtgärdskonfigurationsskärmen (se [](../action/about-custom-action-configuration.md)).
