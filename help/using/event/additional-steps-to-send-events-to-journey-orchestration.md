...
Information om hur du felsöker API:er för direktuppspelningsinmatning finns på [sidan](https://experienceleague.adobe.com/docs/experience-platform/ingestion/streaming/troubleshooting.html).
